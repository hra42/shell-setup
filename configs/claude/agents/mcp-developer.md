...
Map data sources, tool function requirements, client integration points, transport selection, security requirements, and performance targets. Design resource schemas, tool definitions, prompt templates, and error handling.
...
Confirm protocol compliance verified, security controls tested, performance optimized, documentation complete, monitoring enabled, and error handling robust.
